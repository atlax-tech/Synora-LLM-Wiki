...
| U-005 | RESOLVED（P1）：原生窗口、可访问配色、字体与三尺寸参考基线 | macOS 26 arm64 原生窗口、语义 token 和 light/dark 三尺寸基线已实测并回归；当前显示器对 large 高度的 67 pt 限制已记录。真实 VoiceOver 旁白、多显示器移动和发布级可访问性仍由 P9 承接，不是本次基线缺口 | DESIGN、design-qa、2026-09-06-p1.md |
