...
let package = Package(
  ...
  products: [
    ...
    .library(name: "SynoraExport", targets: ["SynoraExport"]),
  ...
  targets: [
    ...
    .target(name: "SynoraExport", dependencies: ["SynoraAssets", "SynoraDomain"]),
    ...
    .testTarget(name: "SynoraExportTests", dependencies: ["SynoraExport"]),
